...
const styles = StyleSheet.create({
  ...
  bg: { flex: 1 },
  content: { flex: 1, paddingHorizontal: 26, paddingTop: Platform.OS === 'ios' ? 64 : 52, paddingBottom: 44, justifyContent: 'space-between' },
  ...
  heroBlock: { flex: 1, justifyContent: 'center', paddingVertical: 20 },

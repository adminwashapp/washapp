    ...
    <div className="min-h-screen bg-[#f9fafb]">
      ...
      <div className="bg-white border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-6 py-8 md:py-12">
          <Link
            href="/blog"
            className="inline-flex items-center gap-2 text-[13px] text-gray-500 hover:text-[#1558f5] mb-6 transition-colors"
          >
          ...
          <p className="text-[1.05rem] text-gray-500 leading-relaxed max-w-2xl">
            {post.excerpt}
          </p>
        </div>
      </div>
        ...
        <aside className="hidden lg:block w-56 flex-shrink-0">
          <div className="sticky top-6 bg-white rounded-2xl border border-gray-100 p-5">
            ...
            <ul className="space-y-2">
              {post.sections.map((s, i) => s.heading && (
                <li key={i}>
                  <a
                    href={`#section-${i}`}
                    className="text-[12px] text-gray-500 hover:text-[#1558f5] leading-snug transition-colors block"
                  >
                    {s.heading}
                  </a>
                </li>
        ...
        <article className="flex-1 max-w-2xl">
          <div className="bg-white rounded-2xl border border-gray-100 p-7 md:p-10">
            ...
            <div className="mt-10 p-6 bg-[#1558f5] rounded-2xl text-white text-center">
              <p className="font-bold text-[1.05rem] mb-1">Prêt à essayer Washapp ?</p>
              <p className="text-blue-100 text-[0.875rem] mb-4">Réservez votre lavage en quelques secondes.</p>
              <Link
                href="/booking"
                className="inline-flex items-center gap-2 bg-white text-[#1558f5] font-bold px-5 py-2.5 rounded-xl text-[0.875rem] hover:bg-blue-50 transition-all"
              >
                Réserver maintenant
                ...
                {related.map((r) => (
                  ...
                  >
                    <span
                      ...
                      style={{ backgroundColor: r.categoryBg, color: r.categoryColor }}
                    >
                      {r.category}
                    </span>
